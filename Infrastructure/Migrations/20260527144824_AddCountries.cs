    ...
    public partial class AddCountries : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServiceOrderServiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ServiceOrderId = table.Column<int>(type: "int", nullable: false),
                    ServiceTypeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceOrderServices", x => x.ServiceOrderServiceId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceOrderServices_ServiceTypes_ServiceTypeId",
                        column: x => x.ServiceTypeId,
                        principalTable: "ServiceTypes",
                        principalColumn: "ServiceTypeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceOrderServices_Users_MechanicId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrderServices_MechanicId",
                table: "ServiceOrderServices",
                column: "MechanicId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrderServices_ServiceOrderId_ServiceTypeId",
                table: "ServiceOrderServices",
                columns: new[] { "ServiceOrderId", "ServiceTypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOrderServices_ServiceTypeId",
                table: "ServiceOrderServices",
